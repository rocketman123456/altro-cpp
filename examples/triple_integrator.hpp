...
namespace altro
{
    namespace examples
    {
        ...
        public:
            ...
            void Evaluate(const VectorXdRef& x, const VectorXdRef& u, float t, Eigen::Ref<VectorXd> xdot) override;
            void Jacobian(const VectorXdRef& x, const VectorXdRef& u, float t, Eigen::Ref<MatrixXd> jac) override;
            void Hessian(const VectorXdRef& x, const VectorXdRef& u, float t, const VectorXdRef& b, Eigen::Ref<MatrixXd> hess) override;
