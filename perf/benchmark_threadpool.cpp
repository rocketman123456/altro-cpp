...
namespace altro
{
    namespace benchmarks
    {
        ...
        void ThreadPoolTiming()
        {
            ...
            auto time_serial = std::chrono::duration_cast<std::chrono::duration<double, std::milli>>(stop - start);
            ...
            auto        time_parallel    = std::chrono::duration_cast<std::chrono::duration<double, std::milli>>(stop - start);
...
int main() { altro::benchmarks::ThreadPoolTiming(); }